    ...
    <section className="relative min-h-screen flex flex-col pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-56">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto drop-shadow mb-10">
          ...
          <a
            href="#consultation"
            className="inline-block bg-white/20 backdrop-blur-xl hover:bg-white/30 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all border border-white/40 shadow-lg hover:shadow-xl"
          >
            숨은 보험금 찾기
          </a>
        </div>
